...
router.register(r'initial-data', v.InitialDataAPIViewSet, basename='fleet_composition')
router.register(r'initial-data/<int:pk>/', v.InitialDataAPIViewSet, basename='fleet_composition')
