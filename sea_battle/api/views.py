...
from sea_battle.api.serializers import UserSerializer, BattleMapSerializer, GameSerializer
...
class BattleMapViewSet(viewsets.ModelViewSet):
    queryset = BattleMap.objects.all()
    serializer_class = BattleMapSerializer
